<template>
  <div class="container-fluid">
    ...
    <div v-if="!error">
        <div class="row">
            <div class="col">
                <h2 class="mt-5" style="color: white;">Technician Leader Board</h2>
...
export default {
  ...
  mounted(){
    axios.get(`http://localhost:5000/technician/summary/${this.userId}`,{
        headers: {
    ...
    .then(response => {
        ...
        this.technicianLables = response.data.tech_labels
        this.requestChart()
        this.leaderChart()
    })
    .catch(error => {
